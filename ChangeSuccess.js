...
var codes = '';
export default class ChangeSuccess extends Component {
    state = {
        name :'',
        email:'',
        phone :'',
        ...
        return (
          <SafeAreaView style={styles.AndroidSafeArea}>
                         <StatusBar backgroundColor="#639ced" barStyle="light-content" />
                               ...
                               <Button
                                   style={{alignSelf:'center',padding:12,marginTop:34,fontSize: 20, color: 'white',backgroundColor:'#D90000',width:'40%',height:50,fontFamily:GLOBAL.semi,borderRadius:4}}
