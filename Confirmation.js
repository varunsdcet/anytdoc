        ...
        return (
            <SafeAreaView>
                ...
                <View style={styles.container}>
                    ...
                    <View style = {{width:window.width,height:300,backgroundColor:'#7BAAED'}}>
                    ...
                    <View style = {{marginLeft:10,width:window.width - 20 ,backgroundColor:'white',height:250,marginTop:-30,    borderWidth: 1,
                        ...
                        <View style = {{flexDirection:'row',justifyContent:'space-around',marginTop:12}}>
                            <Text style={{fontSize : 18,color :'#7BAAED', height:'auto',fontFamily:'Poppins-Medium'}}>
                    ...
                    <Button
                        style={{padding:7,marginTop:'10%',fontSize: 20, color: 'white',backgroundColor:'#7BAAED',alignSelf:'center',width:'50%',height:25,fontFamily:'Poppins-Medium',borderRadius:4}}
