...
export default class MyHealthRecord extends Component {
    state = {
        name :'',
        email:'',
        image :'',
...
//                alert(JSON.stringify(responseJson))
    ...
    renderRowItem2 = (itemData) => {
       ...
       selectedFirst = (index) =>{
         if (index == 5){
           this.props.navigation.navigate('ListSugar')
         }else if (index == 6){
            this.props.navigation.navigate('ListBp')
          }
          else if (index == 4){
...
<Card style = {{marginLeft:10,width:window.width -20,borderRadius:8,marginTop:30}}>
