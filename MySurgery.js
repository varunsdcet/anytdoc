...
export default class MySurgery extends Component {
    state = {
        name :'',
        email:'',
        image :'',
       ...
       fetch(url, {
        ...
        //     alert(JSON.stringify(responseJson))
               ...
               if (responseJson.status == true) {
                   ...
                   this.setState({name :responseJson.user_details.surgeries})
                   if (responseJson.user_details.surgeries == ''){

                   }else{
                     var l = responseJson.user_details.surgeries
