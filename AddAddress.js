              ...
              .then((responseJson) => {
                  ...
                  if (responseJson.status == true) {
                      ...
                      this.setState({location:responseJson.address})
                        this.setState({height:responseJson.address})
                          this.setState({weight:responseJson.area})
                            this.setState({blood_group:responseJson.state})
                              this.setState({allergies:responseJson.zip})
...
var fullAdd = GLOBAL.currentAddress.area + GLOBAL.currentAddress.city
      ...
      fetch(url, {
          ...
          body: JSON.stringify({
              user_id : GLOBAL.user_id,
              address: GLOBAL.currentAddress.address_2,
              area:fullAdd,
              pincode:GLOBAL.currentAddress.zip,
              city_state:GLOBAL.currentAddress.state,
...
SearchFilterFunction(text){
        ...
        return (
                ...
                <View style={styles.container}>
                    <KeyboardAwareScrollView keyboardShouldPersistTaps='always'>
                        ...
                        <Button
                            style={{paddingTop:12,marginTop:28,fontSize: 20, color: 'white',backgroundColor:'#D90000',marginLeft:'5%',width:'90%',height:50,fontFamily:GLOBAL.semi,borderRadius:4}}
  ...
  <TouchableOpacity onPress={()=> this.props.navigation.navigate('Location')}>
                                           <View style = {{width:window.width,height:40,marginTop:-40}}>
                     ...
                     <Text style = {{color:'rgba(0, 0, 0, 0.6)',height:40,width:300,fontSize:18,marginTop:13}}>
                    ...
                    />
                        ...
                        <Button
                            style={{padding:12,marginTop:14,fontSize: 20, color: 'white',backgroundColor:'#D90000',marginLeft:'5%',width:'90%',height:50,fontFamily:GLOBAL.semi,borderRadius:4}}
                            styleDisabled={{color: 'red'}}
                            onPress={() => this.login()}>
                            SAVE
                        </Button>
