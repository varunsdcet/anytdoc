        ...
        return (
            ...
            activeOpacity={0.9}>
                <View style={{ flex: 1 ,marginLeft : 5,width:window.width - 10, backgroundColor: 'white',marginTop: 10,marginBottom:10,borderRadius:10}}>
                    ...
                    <View style = {{flexDirection:'row',width :'100%'}}>
                        ...
                        <View>
                            ...
                            {item.doctor_avail_status == 1 && (
                                ...
                                <Text style={{marginLeft : 10,fontSize : 12,color :'#3DBA56',fontFamily:'Poppins-Medium',width:60,textAlign:'center'}}>
                        ...
                        <View>
                            ...
                            <View style = {{flexDirection:'row',width:'100%'}}>
                                <Text style={{marginLeft : 5,fontSize : 18,color :'#3A3A3A',fontFamily:'Poppins-Medium',width :'70%',marginTop:18,fontWeight:'bold'}}>
                            ...
                            <View style = {{flexDirection:'row'}}>
                                ...
                                <Text style={{marginLeft : 5,width:window.width - 150,height:'auto',fontSize : 12,color :'#8F8F8F',fontFamily:'Poppins-Medium',}}>
                                    ...
                                    Location: {item.lat_long_address}
                                </Text>
                            ...
                            <Text style={{fontSize : 12,color :'#7BAAED',fontFamily:'Poppins-Medium',}}>
                    ...
                    <Button
                        style={{padding:4,marginTop:14,fontSize: 15, color: 'white',backgroundColor:'#7BAAED',marginLeft:'55%',width:'20%',height:34,fontFamily:'Poppins-Medium',borderRadius:12,marginBottom: 20}}
...
*/}
                    ...
                    <View style = {{flexDirection:'row',marginTop: 6,marginLeft:12,width:'100%'}}>
                        <View style = {{flexDirection:'row',width:'70%'}}>
                            ...
                            <Text style = {{color:'#8F8F8F',fontFamily:'Poppins-Medium',fontSize:12}}>
                                Sort by:
                            </Text>
                        ...
                        <TouchableOpacity style = {{width:'35%'}}
                            ...
                            <View style = {{flexDirection:'row',width:'100%'}}>
                                ...
                                <Text style = {{color:'#223B75',fontFamily:'Poppins-Medium',fontSize:12,marginTop:2}}>
                                    Filter
                                </Text>
