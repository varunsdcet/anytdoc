        ...
        return (
            <SafeAreaView>
                <View style={styles.container}>
                        ...
                        <Text style = {{color:'#FFFFFF',fontSize: 36,marginTop: '20%',fontFamily:'Poppins-Regular',textAlign:'center',fontWeight:'bold'}}>
                           Select Your Nurse
                        ...
                        <Button
                            style={{padding:7,marginTop:'20%',fontSize: 20, color: '#7BAAED',backgroundColor:'white',marginLeft:'5%',width:'90%',height:40,fontFamily:'Poppins-Medium',borderRadius:4,fontWeight:'bold'}}
