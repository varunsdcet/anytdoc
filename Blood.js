...
this.getNewsUpdate()
  ...
  var b = {
    "systolic_pressure":this.state.before,
    "diastolic_pressure":this.state.after,
    "measured_arm":this.state.relation,
...
<Card style = {{marginLeft:10,width:window.width -20,borderRadius:8,marginTop:30,backgroundColor:'white',height:337}}>
...
<TextInput
                  ...
                  placeholder="Enter "
                     keyboardType={"numeric"}
                  onChangeText={(text) => this.setState({after:text})}
              />
