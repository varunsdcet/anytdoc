...
export default class MyIllness extends Component {
    state = {
        name :'',
        email:'',
        image :'',
       ...
       fetch(url, {
           ...
           .then((responseJson) => {
               ...
               if (responseJson.status == true) {
                   ...
                   this.setState({name :responseJson.user_details.illnesses})
                   if (responseJson.user_details.illnesses == ''){

                   }else{
                     var l = responseJson.user_details.illnesses
