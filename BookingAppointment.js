        ...
        if (res == null || res.length == 0) {
            ...
            for (var i = 0; i < array.length; i++) {
                if (array[i].selected == "Y") {
                    speciality = speciality + array[i].name + ','
...
this.hideLoading()
    ...
    selectedFirst = (item,speciality) => {
        ...
        GLOBAL.appointmentArray = item
            this.props.navigation.navigate('DoctorDetail',item.id)
    ...
    _renderDepartmentss =  ({item,index}) => {
        return (
            <View style = {{backgroundColor:'white',borderRadius:12 ,margin :2,height:30}}>
...
*/}
                    ...
                    <View style = {{flexDirection:'row',marginTop: 6,marginLeft:12,width:'100%'}}>
                        ...
                        <Text style = {{color:'#8F8F8F',fontFamily:GLOBAL.semi,fontSize:13,fontWeight:'bold'}}>
                            Sort by:
                        </Text>

                        <Text style = {{color:'black',fontFamily:GLOBAL.semi,fontSize:12,marginTop:0,marginLeft:1}}>
                          { this.Capitalize(this.state.text)}
                        </Text>
                            <TouchableOpacity onPress={()=>this.setModalVisible(true)}>

                        <Image style = {{width :14 ,height: 14,alignSelf:'center',resizeMode: 'contain',marginLeft:10, marginTop:2}}
                               source={require('./sort.png')}/>
                            </TouchableOpacity>
                    </View>

                        <TouchableOpacity style = {{width:'35%'}}
                                              onPress={()=>this.props.navigation.navigate('MyFilter')}>
                    ...
                    <Text style = {{color:'black',fontFamily:GLOBAL.semi,marginTop:2,fontSize:13,fontWeight:'bold'}}>
                        Filter
                    </Text>
...
<Image style = {{width :25 ,height: 25,alignSelf:'center',resizeMode: 'contain',marginLeft:10,marginTop:1,marginBottom:5}}
       source={require('./location.png')}/>
       <Text style = {{color:'#1E1F20',fontFamily:GLOBAL.semi,marginTop:8,marginBottom:10,width:200,fontSize:13,fontWeight:'bold'}} numberOfLines = {1}>
       ...
       <Button
           ...
           Change
                    ...
                    <FlatList style= {{flexGrow:0,margin:8,marginLeft:0}}
